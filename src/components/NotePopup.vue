    ...
    <div class="post popup">
      <div class="popup-card">
        <div class="upper-bar flex-column">
          <h1 class="movie-title">Notatka dla filmu: {{ movieData.title }}</h1>
        ...
        <div class="lower-bar">
          <div class="popup-action-buttons">
            <div class="icon-button flex-column" @click="deleteNote">
              <img src="@/assets/img/delete-icon.png" alt="Delete icon"/>
              <span class="button-span">Usuń</span>
            </div>
            <div class="icon-button flex-column" @click="editNote">
