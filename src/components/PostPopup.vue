...
const deletePost = () => {
  postStore.deleteUserPost(props.postData.id)
  isSaved.value = false;
  content.value = '';
      ...
      <div class="popup-card">
        ...
        <div class="lower-bar">
          <div class="popup-action-buttons">
            <div class="icon-button flex-column" @click="deletePost" v-if="readOnly">
          ...
          <RatingStars read-only :rating="postData.userRating"></RatingStars>
